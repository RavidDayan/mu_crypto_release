...
// DO NOT MODIFY
// GENERATED ON: 2025-08-19 15:25:18.720419
...
/**
  ...
  @param[in]  ParameterSet  ML-DSA parameter set (CRYPTO_NID_ML_DSA_44, 
                            CRYPTO_NID_ML_DSA_65, or CRYPTO_NID_ML_DSA_87).
  @return  Pointer to the ML-DSA context that has been initialized.
           If the allocation fails, MlDsaNew() returns NULL.
**/
// FROM BaseCryptLib.h:4351
typedef
VOID *
(EFIAPI *EDKII_CRYPTO_ML_DSA_NEW)(
  IN  UINTN  ParameterSet
  );
...
/**
  ...
  This function generates ML-DSA public and private key pair according to the specified
  parameter set. The generated keys are stored in the ML-DSA context.
  ...
  @param[out]      PublicKey       Pointer to the buffer to receive the public key.
  @param[in, out]  PublicKeySize   On input, the size of PublicKey buffer in bytes.
                                   On output, the size of data returned in PublicKey buffer in bytes.
  @param[out]      PrivateKey      Pointer to the buffer to receive the private key.
...
/**
  ...
  @retval  FALSE  Invalid ML-DSA public key or context.
**/
// FROM BaseCryptLib.h:4416
typedef
BOOLEAN
...
/**
  ...
  @retval  FALSE  Invalid ML-DSA private key or context.
**/
// FROM BaseCryptLib.h:4438
typedef
BOOLEAN
...
/**
  ...
  This function carries out the ML-DSA signature generation according to FIPS-204.
  If the Signature buffer is too small to hold the contents of signature, FALSE
  is returned and SigSize is set to the required buffer size to obtain the signature.
  If MlDsaContext is NULL, then return FALSE.
  If Message is NULL, then return FALSE.
  If Signature is NULL and SigSize is not NULL, then return FALSE.
...
/**
  ...
  This function verifies the ML-DSA signature according to FIPS-204.
  If MlDsaContext is NULL, then return FALSE.
  If Message is NULL, then return FALSE.
  If Signature is NULL, then return FALSE.
