...
// DO NOT MODIFY
// GENERATED ON: 2025-08-19 15:25:18.690931
...
const EDKII_CRYPTO_PROTOCOL  mEdkiiCrypto = {
 ...
 #endif
  // MLDSA functions
 #if _PCD_VALUE_PcdCryptoServiceMlDsaNew
  MlDsaNew,
 #else
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceMlDsaFree
  MlDsaFree,
 #else
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceMlDsaGenerateKey
  MlDsaGenerateKey,
 #else
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceMlDsaSetPublicKey
  MlDsaSetPublicKey,
 #else
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceMlDsaSetPrivateKey
  MlDsaSetPrivateKey,
 #else
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceMlDsaSign
  MlDsaSign,
 #else
  NULL,
 #endif
 #if _PCD_VALUE_PcdCryptoServiceMlDsaVerify
  MlDsaVerify,
 #else
  NULL,
 #endif
